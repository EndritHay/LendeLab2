...
export default function Navbar() {
    ...
    <>
        <nav className="bg-white fixed w-full z-20 top-0 left-0 border-b border-gray-200">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div onClick={() => router.push("/")} className="flex items-center cursor-pointer">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap">PREEN</span>
                </div>
                <div className="flex md:order-2 gap-2">
                    ...
                    <path
                        fill-rule="evenodd"
                        d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1"
                        clip-rule="evenodd"
                    ></path>
                    </svg>
                    </button>
        ...
        show={showNavModal} setShow={setShowNavModal}  isAdminView={isAdminView}/>
    </>
    )
}
//2:32:34